...
import { Table, SearchResult } from './insurancetable.model';
import { tableData } from './data';
import { SortDirection } from './insurancetable-sortable.directive';
...
function matches(tables: Table, term: string, pipe: PipeTransform) {
    return tables.billId.toLowerCase().includes(term.toLowerCase())
        || tables.billDate.toLowerCase().includes(term)
        || tables.patient.toLowerCase().includes(term)
        || tables.payments.toLowerCase().includes(term)
